      ...
      <div class="row">
        ...
        <h1>
          ...
          <div class="navigation">
            <nav>
              <ul class="sf-menu">
               <li class="current"><a href="index.jsp"><spring:message code="menu.home"></spring:message></a></li>
               <li><a href="index-1.html"><spring:message code="menu.about"></spring:message></a></li>
               <li><a href="index-2.html"><spring:message code="menu.news"></spring:message></a></li>
               <li><a href="index-3.html"><spring:message code="menu.services"></spring:message></a></li>
               <li><a href="index-4.html"><spring:message code="menu.contacts"></spring:message></a></li>
             </ul>
            </nav>        
            <div class="clear"></div>
          </div>
  ...
  <div class="container">
    <div class="row">
      <div class="grid_12">  
        ...
        <div class="copyright"><span class="brand">Bliss </span> &copy; <span id="copyright-year"></span> | <a href="#">Privacy Policy</a> <div>More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></div>
        </div>
      </div>
    </div>
  </div> 
